    ...
    <div className="flex flex-col items-center justify-center bg-[#f6f6f6] ">
      ...
      <div className="shadow-xl  w-full">
        ...
        <header className="text-center mb-8">
          ...
          >
            The Only{' '}
            <span className="font-extralight text-purple-600">&lt;Package&gt;</span> you
        ...
        <div className='px-8 flex flex-col items-center justify-center overflow-x-hidden '>
          {/* Feature cards */}
          <div id="features" className="flex flex-col md:flex-row justify-between gap-0 p-0 m-0 w-[1027px]">
        ...
        <div id="testimonials" style={{ background: '#0A0A0A' }} className="text-white p-8 w-full text-center mt-10 relative">
          <h2 style={{ color: '#9747FF' }} className="text-[36px] mb-6">
          ...
          <br></br>
          <div className='flex flex-col items-center justify-center overflow-x-hidden w-full relative'>          
          <div className="flex flex-col md:flex-row  mb-10 space-y-4 md:space-y-0 md:space-x-4  lg:w-[1027px]">
            <div
            ...
            >
              ...
              <p className="text-2xl font-extrabold leading-tight text-right text-lavender p-4 rounded-lg">
                No Fake Accounts
              </p>
              <p className=" text-base font-normal leading-tight text-left">
            ...
            >
              ...
              <p className=" text-base font-normal leading-tight text-left">Don’t loose your precious time in spam filled social media groups</p>
              <br></br>
              <p className=" text-base font-normal leading-tight text-left">Forget infinite scrolling in those muted group chats filled with irrelevant texts</p>
            </div>
            <div
              className="border border-purple-600 rounded-lg p-6 text-center text-white flex flex-col items-center hover:shadow-lg transition duration-300"
              style={{
            ...
            >
              ...
              <p className=" text-base font-normal leading-tight text-left">Hey girl !! Yes you ! Take charge of your DM. Choose who can text  you</p>
              <br></br>
              <p className=" text-base font-normal leading-tight text-left">No more stress of blocking creepy freaks from the public groups that bother you in DM</p>
            </div>
          </div>
          </div>
          <Link href="#" >
