...
//   return (
//     <div className="h-full bg-[#A580C0]">
...
//           </p>
//         </div>
//         <div className="mx-auto max-w-7xl py-12 md:py-24 bg-[#8A59AE]">
...
//                       />
//                       <CldUploadButton
//                         className="bg-[#4B0082] rounded-full px-6 py-2"
...
//                     type="button"
//                     className="w-full rounded-md bg-[#4B0082] px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-[#4B0082]/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#4B0082]"
//                   >
//                     Create Profile
//                   </button>
...
function Page() {
  ...
  return (
    <div className="h-full bg-lavender">
      <div className="mx-auto max-w-7xl px-4">
        <div className="flex flex-col space-y-8 pb-10 pt-12 md:pt-24">
          <div className="mx-auto max-w-max rounded-full border bg-gray-50 p-1 px-3">
        ...
        <div className="mx-auto max-w-7xl py-12 md:py-24 bg-royal-purple">
          <div className="grid items-center justify-items-center gap-x-4 gap-y-10 lg:grid-cols-2">
            <div className="flex items-center justify-center">
              <div className="px-2 md:px-12">
                ...
                <form action="" className="mt-8 space-y-4">
                  <div className="grid w-full gap-y-4 md:gap-x-4 lg:grid-cols-2">
                    <div className="grid w-full items-center gap-1.5">
                      <label
                        className="text-sm font-medium leading-none text-gray-50 peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                        htmlFor="phone_number"
                      >
                        Profile Image
                      </label>
                  ...
                  <div className="grid w-full  items-center gap-1.5">
                    ...
                    <select
                      className="flex h-10 w-full rounded-md border border-gray-300 bg-transparent px-3 py-2 text-sm text-gray-50 placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-gray-400 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50 dark:border-gray-700 dark:focus:ring-gray-400 dark:focus:ring-offset-gray-900"
                      id="gender"
