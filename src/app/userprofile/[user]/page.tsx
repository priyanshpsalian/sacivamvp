...
function Page() {
  ...
  // Upload image
  const uploadImage = useCallback(async (result: any) => {
  ...
  // const profileUploaded = useCallback(async () => {
  //   try {
  //     const response = await axios.post("/api/user", {
  //       email, name, gender, age: parseInt(age), image: imagelink, university, startYear, endYear, major, language, country,
  //       foodPreference, smoke, drink, expenditure, houseAmbiance, tidiness, socializing, aboutYourself
  ...
  //     console.log(error);
  //   }
  // }, [email, name, gender, age, imagelink, university, startYear, endYear, major, language, country, foodPreference, smoke, drink, expenditure, houseAmbiance, tidiness, socializing, aboutYourself, router]);
