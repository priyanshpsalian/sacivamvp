  ...
  return (
    <div className="relative w-full bg-[#f6f6f6]">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
        ...
        <div className="inline-flex items-center space-x-2">
          <Image
            src="https://d3l4smlx4vuygm.cloudfront.net/logo.png"
            alt="SACIVA Logo"
            width={70}
            height={70}
          />
         ...
         <div className="flex space-x-4">
          ...
          <Link href="/auth/login">
            <button
              type="button"
              className="w-full rounded-md bg-gray-300 px-3 py-2 text-sm font-semibold text-black shadow-sm hover:bg-gray-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
            >
              Login
            </button>
          </Link>
          ...
          <Link href="/auth/signup">
              ...
              <button
                type="button"
                className="w-full rounded-md bg-purple-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-purple-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
              >
                Sign Up
              </button>
